...
# )
declare -A test_scenario14=(
    [name]="15-oidc_auth_code_redirect_with_consent_without_pre_issue_access_token_action"
    [display_name]="OIDC Auth Code Grant Redirect With Consent & Without Pre-Issue Access Token Action"
    [description]="Obtain an access token and an id token using Auth code grant type and without pre-issue access token action."
    [jmx]="oidc/OIDC_AuthCode_Redirect_WithConsent.jmx"
    [tenantMode]=false
    [skip]=false
    [modes]="FULL QUICK PUBLISH"
