...
#)
  declare -A test_scenario14=(
      [name]="15-oidc_auth_code_redirect_with_consent_with_adaptive_authentication"
      [display_name]="OIDC Auth Code Grant Redirect With Consent with Adaptive Authentication"
      [description]="Obtain an access token and an id token using Auth code grant type and adaptive script execution."
      [jmx]="oidc/OIDC_AuthCode_Redirect_WithConsent.jmx"
      [tenantMode]=false
      [skip]=false
      [modes]="FULL QUICK PUBLISH"
