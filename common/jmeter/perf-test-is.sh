...
function run_test_data_scripts() {
    ...
    echo "=========================================================================================="
    declare -a scripts=("TestData_Add_Tenants.jmx" "TestData_SCIM2_Add_Tenant_Users.jmx" "TestData_Add_OAuth_Apps_Without_Consent.jmx" "TestData_Get_OAuth_Jwt_Token.jmx")
